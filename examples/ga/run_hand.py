...
from .robot_converter import load_robot_from_json
    ...
    while True:
        ...
        for structure in structures:
            ...
            if structure.is_survivor:
                save_path_controller_part = os.path.join("saved_data", exp_name, "generation_" + str(generation),
                                                         "controller",
                                                         f"{structure.label}.zip")
                save_path_controller_part_old = os.path.join("saved_data", exp_name,
                ...
                ppo_args = (
                args, structure.body, env_name, save_path_controller, f'{structure.label}', structure.connections)
        ...
        while num_children < (pop_size - num_survivors) and num_evaluations < max_evaluations:
            ...
            child = mutate(survivors[parent_index[0]].body.copy(), mutation_rate=0.5, num_attempts=150)
